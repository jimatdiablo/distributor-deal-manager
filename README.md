...
2. Start project MySQL (first-time setup):
...
5. Restart the app after any .env change.
...
This project includes docker-compose.yml and auto-init SQL at docker/mysql/init/001_schema.sql.

Schema migration helpers:
- sql/migration_add_country_columns.sql
- sql/migration_rename_street_to_address.sql

Provisioned objects:
- database: distdb
- tables: agent, deals, distributors, providers
...
Run this from the project folder after the database schema is loaded:
